...
export class CreatedRealtionStudentClass1606833198070 implements MigrationInterface {
    name = 'CreatedRealtionStudentClass1606833198070'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "student_classes_class" ("studentId" integer NOT NULL, "classId" uuid NOT NULL, CONSTRAINT "PK_9f2c655a5feb7cff342af016c8e" PRIMARY KEY ("studentId", "classId"))`);
